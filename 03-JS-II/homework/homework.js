...
function conection(status) {
  ...
  var m;
  if (status===1){m="Online";}
  else if (status===2){m="Away";}
  else {m="Offline";}
  return m;
}
...
function saludo(idioma) {
  ...
  // Tu código:
  var m;
  if (idioma==="aleman"){m="Guten Tag!";}
  else if (idioma==="mandarin"){m="Ni Hao!";}
  else if (idioma==="ingles"){m="Hello!";}
  else {m="Hola!";}
  return m;
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  let arraytabla=[]
  for(i=0;i<11;i++){arraytabla.push( 6*i);}
  return arraytabla;
}
